...
abstract_curve::abstract_curve(vector<point2d> &control_points): control_points(control_points)
{
	t_min = 0;
	t_max = 1;
}
...
const vector<point2d>& abstract_curve::get_control_points() const
{
...
// in the main window
void abstract_curve::set_text(stringstream &stream)
{
	// ... does nothing and should be specified in inherited classes
	// if needed.
}
